...
/**
 * Servlet implementation class AdminMainPageNoticeServlet
 */
@WebServlet("/adminMain.t.no")
public class AdminMainPageNoticeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminMainPageNoticeServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Notice> list = new NoticeService().adminMainPageNotice(pi);
